...
from financial_ai.ml.transaction_classification.core.contracts import ClassificationMethod
from financial_ai.ml.transaction_classification.core.text_classification_rules import (
    match_text_category,
)
